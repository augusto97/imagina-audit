      ...
      <Card className="border-[var(--color-warning)]/30 bg-[var(--color-warning)]/5">
        <CardContent className="p-6">
          <div className="flex items-start gap-4">
            <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-[var(--color-warning)]/20">
              <DollarSign className="h-6 w-6 text-[var(--color-warning)]" strokeWidth={1.5} />
            </div>
            <div className="flex-1">
              <div className="flex items-center gap-2">
                <h3 className="text-lg font-semibold text-[var(--text-primary)]">Impacto Económico Estimado</h3>
                <TrendingDown className="h-4 w-4 text-[var(--color-warning)]" strokeWidth={1.5} />
              </div>
